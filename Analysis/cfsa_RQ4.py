...
for dataset in ['Adult-Sex','Adult-Race','Compas-Sex','German-Sex','Bank-Age','Heart-sex','Law-Sex','Dutch-Sex','Default-sex']:
    ...
    for num in range(0,11):
        for dataset in ['Adult-Sex','Adult-Race','Compas-Sex','German-Sex','Bank-Age','Heart-sex','Law-Sex','Dutch-Sex','Default-sex']:
            ...
            if dataset == 'Mep-Race':
                dataset_pre = 'mep'
                dataset_aft = 'RACE'
            fin = open('../RQ7_result/ESEC_'+j+'_'+dataset_pre+'_'+dataset_aft+'_'+str(num)+str(10-num)+'.txt','r')
            count = 0
            for line in fin:
                count=count+1

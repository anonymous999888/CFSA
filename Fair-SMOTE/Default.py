...
if __name__ == '__main__':
    ...
    dataset_orig = dataset_orig.drop(
        ['ID', 'LIMIT_BAL', 'BILL_AMT1', 'BILL_AMT2', 'BILL_AMT3', 'BILL_AMT4', 'BILL_AMT5', 'BILL_AMT6', 'PAY_AMT1',
    ...
    val_name = "fairsmote_{}_default_{}.txt".format(model_type, protected_attribute)
    ...
    for p_index in performance_index:
        ...
        fout.write('%f\t%f\n' % (np.mean(results[p_index]),std(results[p_index])))
    fout.close()